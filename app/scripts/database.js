var database = [
    ...
    },
    {
        ...
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E",
        "Initial": "an element of type E"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo]",
        "Initial": "an E element with a \"foo\" attribute"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo=\"bar\"]",
        "Initial": "an E element whose \"foo\" attribute value is exactly      equal to \"bar\""
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo~=\"bar\"]",
        "Initial": "an E element whose \"foo\" attribute value is a list of      whitespace-separated values, one of which is exactly equal to \"bar\""
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo^=\"bar\"]",
        "Initial": "an E element whose \"foo\" attribute value begins      exactly with the string \"bar\""
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo$=\"bar\"]",
        "Initial": "an E element whose \"foo\" attribute value ends exactly      with the string \"bar\""
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo*=\"bar\"]",
        "Initial": "an E element whose \"foo\" attribute value contains the      substring \"bar\""
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E[foo|=\"en\"]",
        "Initial": "an E element whose \"foo\" attribute has a      hyphen-separated list of values beginning (from the left) with \"en\""
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:root",
        "Initial": "an E element, root of the document"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:nth-child(n)",
        "Initial": "an E element, the n-th child of its parent"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:nth-last-child(n)",
        "Initial": "an E element, the n-th child of its parent, counting      from the last one"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:nth-of-type(n)",
        "Initial": "an E element, the n-th sibling of its type"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:nth-last-of-type(n)",
        "Initial": "an E element, the n-th sibling of its type, counting      from the last one"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:first-child",
        "Initial": "an E element, first child of its parent"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:last-child",
        "Initial": "an E element, last child of its parent"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:first-of-type",
        "Initial": "an E element, first sibling of its type"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:last-of-type",
        "Initial": "an E element, last sibling of its type"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:only-child",
        "Initial": "an E element, only child of its parent"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:only-of-type",
        "Initial": "an E element, only sibling of its type"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:empty",
        "Initial": "an E element that has no children (including text      nodes)"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:link<br>      E:visited",
        "Initial": "an E element being the source anchor of a hyperlink of      which the target is not yet visited (:link) or already visited      (:visited)"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:active<br>      E:hover<br>      E:focus",
        "Initial": "an E element during certain user actions"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:target",
        "Initial": "an E element being the target of the referring URI"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:lang(fr)",
        "Initial": "an element of type E in language \"fr\" (the document      language specifies how language is determined)"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:enabled<br>      E:disabled",
        "Initial": "a user interface element E which is enabled or      disabled"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:checked<!--<br>E:indeterminate-->",
        "Initial": "a user interface element E which is      checked<!-- or in an      indeterminate state--> (for instance a      radio-button or checkbox)"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E::first-line",
        "Initial": "the first formatted line of an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E::first-letter",
        "Initial": "the first formatted letter of an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E::before",
        "Initial": "generated content before an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E::after",
        "Initial": "generated content after an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E.warning",
        "Initial": "an E element whose class is \"warning\" (the document      language specifies how class is determined)."
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E#myid",
        "Initial": "an E element with ID equal to \"myid\"."
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E:not(s)",
        "Initial": "an E element that does not match simple selector s"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E F",
        "Initial": "an F element descendant of an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E &gt; F",
        "Initial": "an F element child of an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E + F",
        "Initial": "an F element immediately preceded by an E element"
    },
    {
        "spec name": "Selectors Level 3",
        "uri": "http://www.w3.org/TR/css3-selectors",
        "Name": "E ~ F",
        "Initial": "an F element preceded by an E element"
    },
    {
    ...
    },
    {
        ...
        "Name": "filter",
        "Categories": "None.",
        "Content model": "Any number of the following elements, in any order:\n      \n       descriptive\n         — <desc>, <title>, <metadata>\n\n       filter primitive  — <feBlend>, <feFlood>, <feColorMatrix>, <feComponentTransfer>, <feComposite>, <feConvolveMatrix>, <feCustom>, <feDiffuseLighting>, <feDisplacementMap>, <feDropShadow>, <feGaussianBlur>, <feImage>, <feMerge>, <feMorphology>, <feOffset>, <feSpecularLighting>, <feTile>, <feTurbulence>\n\n       <animate>\n\n       <set>",
        "Attributes": "core\n        attributes — ‘id’, ‘xml:base’, ‘xml:lang’, ‘xml:space’\n\n       presentation\n        attributes — ‘alignment-baseline’, ‘baseline-shift’, ‘clip’, ‘clip-path’, ‘clip-rule’, ‘color’, ‘color-interpolation’, ‘color-interpolation-filters’, ‘color-profile’, ‘color-rendering’, ‘cursor’, ‘direction’, ‘display’, ‘dominant-baseline’, ‘enable-background’, ‘fill’, ‘fill-opacity’, ‘fill-rule’, ‘filter’,\n        ‘flood-color’, ‘flood-opacity’, ‘font’, ‘font-family’, ‘font-size’, ‘font-size-adjust’, ‘font-stretch’, ‘font-style’, ‘font-variant’, ‘font-weight’, ‘glyph-orientation-horizontal’, ‘glyph-orientation-vertical’, ‘image-rendering’, ‘kerning’, ‘letter-spacing’, ‘lighting-color’, ‘marker’, ‘marker-end’, ‘marker-mid’, ‘marker-start’, ‘mask’, ‘mix-blend-mode’, ‘opacity’, ‘overflow’, ‘pointer-events’, ‘shape-rendering’, ‘stop-color’, ‘stop-opacity’, ‘stroke’, ‘stroke-dasharray’, ‘stroke-dashoffset’, ‘stroke-linecap’, ‘stroke-linejoin’, ‘stroke-miterlimit’, ‘stroke-opacity’, ‘stroke-width’, ‘text-anchor’, ‘text-decoration’, ‘text-rendering’, ‘unicode-bidi’, ‘visibility’, ‘word-spacing’, ‘writing-mode’\n\n       xlink\n        attributes — ‘xlink:type’, ‘xlink:role’, ‘xlink:arcrole’, ‘xlink:title’\n\n       ‘class’\n\n       ‘style’\n\n       ‘externalResourcesRequired’\n\n       ‘x’\n\n       ‘y’\n\n       ‘width’\n\n       ‘height’\n\n       ‘filterRes’\n\n       ‘filterUnits’\n\n       ‘primitiveUnits’\n\n       ‘xlink:href’",
    ...
    },
    {
        ...
        "category": "css-property",
        "Name": "feFuncR",
        "Categories": "Transfer function\n       element",
        "Content model": "Any number of the following elements, in any order:\n       \n        <animate>\n\n        <set>",
        "Attributes": "core\n         attributes — ‘id’, ‘xml:base’, ‘xml:lang’, ‘xml:space’\n\n        transfer function\n         element attributes — ‘type’, ‘tableValues’, ‘slope’, ‘intercept’, ‘amplitude’, ‘exponent’, ‘offset’",
    ...
    },
    {
        ...
        "Categories": "Filter primitive\n          element",
        "Content model": "Any number of descriptive\n          elements and exactly one light source element, in any\n          order.",
        "Attributes": "core\n            attributes — ‘id’, ‘xml:base’, ‘xml:lang’, ‘xml:space’\n\n           presentation\n            attributes — ‘alignment-baseline’, ‘baseline-shift’, ‘clip’, ‘clip-path’, ‘clip-rule’, ‘color’, ‘color-interpolation’, ‘color-interpolation-filters’, ‘color-profile’, ‘color-rendering’, ‘cursor’, ‘direction’, ‘display’, ‘dominant-baseline’, ‘enable-background’, ‘fill’, ‘fill-opacity’, ‘fill-rule’, ‘filter’, ‘flood-color’, ‘flood-opacity’, ‘font’, ‘font-family’, ‘font-size’, ‘font-size-adjust’, ‘font-stretch’, ‘font-style’, ‘font-variant’, ‘font-weight’, ‘glyph-orientation-horizontal’, ‘glyph-orientation-vertical’, ‘image-rendering’, ‘kerning’, ‘letter-spacing’, ‘lighting-color’, ‘marker’, ‘marker-end’, ‘marker-mid’, ‘marker-start’, ‘mask’, ‘mix-blend-mode’, ‘opacity’, ‘overflow’, ‘pointer-events’, ‘shape-rendering’, ‘stop-color’, ‘stop-opacity’, ‘stroke’, ‘stroke-dasharray’, ‘stroke-dashoffset’, ‘stroke-linecap’, ‘stroke-linejoin’, ‘stroke-miterlimit’, ‘stroke-opacity’, ‘stroke-width’, ‘text-anchor’, ‘text-decoration’, ‘text-rendering’, ‘unicode-bidi’, ‘visibility’, ‘word-spacing’, ‘writing-mode’\n\n           filter primitive\n            attributes — ‘x’, ‘y’, ‘width’, ‘height’, ‘result’\n\n           ‘class’\n\n           ‘style’\n\n           ‘in’\n\n           ‘surfaceScale’\n\n           ‘diffuseConstant’\n\n           ‘kernelUnitLength’",
